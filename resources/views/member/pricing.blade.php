...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('stream/assets/css/style.css') }}">
    <style type="text/tailwindcss">
        @layer components {
            ...
            .pricing-card {
                @apply flex flex-col p-[30px] bg-white rounded-2xl w-full w-[330px] max-w-max max-w-[330px];
            }
        }
    </style>
...
<body class="bg-stream-dark">
                    ...
                    <div class="mt-[70px] flex justify-center gap-[40px] flex-wrap">
                        ...
                        <div class="pricing-card">
                            ...
                            <form action="{{ route('member.transaction.store') }}" method="post">
                                ...
                                <button type="submit"
                                    class="mt-10 py-3 block outline outline-1 outline-stream-gray rounded-full text-center p-5">
                        ...
                        <div class="pricing-card">
                            ...
                            <form action="{{ route('member.transaction.store') }}" method="post">
                                ...
                                <button type="submit"
                                    class="mt-10 py-3 block bg-indigo-600 rounded-full text-center p-5">
    ...
    <script src="https://code.jquery.com/jquery-3.6.0.min.js'"
        ...
        < /> <
        script src = "{{ asset('stream/assets/script/script.js') }}" >
    </script>
</body>
